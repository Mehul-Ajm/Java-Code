...
@Autonomous(name = "Auto Front Blue New", group = "Auto")
public class AutoFrontBlue extends OpMode {
    ...
    private final Pose startPose = new Pose(16, 124, Math.toRadians(135));
    private final Pose scorePoseFront = new Pose(48, 85, Math.toRadians(135));
    private final Pose setup1Pose = new Pose(45, 84, Math.toRadians(180));
    private final Pose pickup1Pose = new Pose(12, 84, Math.toRadians(180));


    private Path scorePreload;
    private PathChain setup1, pickup1, shootPickup1;
